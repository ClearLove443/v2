import{_ as n,V as s,W as a,a0 as e}from"./framework-0db4e8b6.js";const i={},t=e(`<h2 id="创建或修改-etc-docker-daemon-json-文件-并写入以下内容" tabindex="-1"><a class="header-anchor" href="#创建或修改-etc-docker-daemon-json-文件-并写入以下内容" aria-hidden="true">#</a> 创建或修改 /etc/docker/daemon.json 文件，并写入以下内容：</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/docker/daemon.json
