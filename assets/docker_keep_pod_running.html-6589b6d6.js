import{_ as a,V as s,W as e,a0 as t}from"./framework-7c77a285.js";const l={};function i(u,n){return s(),e("div",null,n[0]||(n[0]=[t(`<p>保持docker 的容器运行不停止，有以下几种方法</p><h2 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> docker</h2><ol><li>docker run</li></ol><p>使用pseudo-tty和detach选项（docker run命令上的-itd选项）来保持容器在Docker容器上运行，不会关闭。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-itd</span> ubuntu
...
# CMD exec /bin/bash -c &quot;while true; do sleep 30; done;&quot;
# CMD exec /bin/bash -c &quot;trap : TERM INT; sleep infinity &amp;amp; wait&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,20)]))}const p=a(l,[["render",i],["__file","docker_keep_pod_running.html.vue"]]);export{p as default};
