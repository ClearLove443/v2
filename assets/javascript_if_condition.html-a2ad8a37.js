import{_ as i,V as e,W as n,a0 as l}from"./framework-80bf61a6.js";const a={},d=l(`<p>if(condition){} 中，有以下几种类型会被判定为假值：</p><ul><li>null</li><li>undefined</li><li>0</li><li>&quot;&quot;</li><li>false</li><li>void 0</li><li>NaN</li></ul><p>如果一个变量是没有声明的是不能直接判断的，比如下面的判断会报错。</p><div class="language-javaScript line-numbers-mode" data-ext="javaScript"><pre class="language-javaScript"><code>// 在全局域，非方法内
if(a) {
    console.log(1)
} else {
    console.log(2)
