import{_ as e,V as i,W as n,a0 as t}from"./framework-74e9649d.js";const d={},s=t(`<h1 id="直接执行-cmd-命令的时候-显示的黑框不太美观。可以把黑框隐藏掉。推荐使用第一种。" tabindex="-1"><a class="header-anchor" href="#直接执行-cmd-命令的时候-显示的黑框不太美观。可以把黑框隐藏掉。推荐使用第一种。" aria-hidden="true">#</a> 直接执行 cmd 命令的时候，显示的黑框不太美观。可以把黑框隐藏掉。推荐使用第一种。</h1><ul><li>新建个 vbs 文件</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>set ws=WScript.CreateObject(&quot;WScript.Shell&quot;)
&#39;ws.Run &quot;yy.bat&quot;,0
