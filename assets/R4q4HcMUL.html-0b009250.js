import{_ as e,D as s,V as i,W as l,Y as a,Z as t,$ as p,a0 as r}from"./framework-8e76daeb.js";const o={},c={href:"https://developer.aliyun.com/article/708980",target:"_blank",rel:"noopener noreferrer"},d=r(`<h2 id="方法一" tabindex="-1"><a class="header-anchor" href="#方法一" aria-hidden="true">#</a> 方法一</h2><p>运行</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token string">&#39;9090:9090&#39;</span> <span class="token parameter variable">--name</span> springboot-demo <span class="token parameter variable">-v</span> D:/Workspace/SpringBootDemo/target/SpringBootDemo-0.0.1-SNAPSHOT.war:/app.jar openjdk:11.0.11-jre-slim <span class="token function">java</span> <span class="token parameter variable">-jar</span> /app.jar
