import{_ as n,D as s,V as t,W as d,Y as e,Z as i,$ as r,a0 as a}from"./framework-0db4e8b6.js";const o={},p=a(`<h1 id="display-的所有属性" tabindex="-1"><a class="header-anchor" href="#display-的所有属性" aria-hidden="true">#</a> display 的所有属性</h1><pre><code>/* CSS 1 */
display: none;
display: inline;
display: block;
display: list-item;
