...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装-docker-compose" tabindex="-1"><a class="header-anchor" href="#安装-docker-compose" aria-hidden="true">#</a> 安装 docker compose</h2>`,30),m={href:"https://clearlove443.github.io/v2/blogs/docker/docker-compose-install.html",target:"_blank",rel:"noopener noreferrer"},k=i(`<h2 id="ubuntu修改ip" tabindex="-1"><a class="header-anchor" href="#ubuntu修改ip" aria-hidden="true">#</a> ubuntu修改ip</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /etc/netplan/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="添加用户到sudo-用户组" tabindex="-1"><a class="header-anchor" href="#添加用户到sudo-用户组" aria-hidden="true">#</a> 添加用户到sudo 用户组</h2>`,5),b={href:"https://clearlove443.github.io/v2/blogs/linux/linux_user_add_delete.html",target:"_blank",rel:"noopener noreferrer"},h=n("h2",{id:"ssh免密码登录",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#ssh免密码登录","aria-hidden":"true"},"#"),s(" ssh免密码登录")],-1),g={href:"https://clearlove443.github.io/v2/blogs/linux/linux_ssh_add_privtekey.html",target:"_blank",rel:"noopener noreferrer"};function f(x,_){const a=t("ExternalLinkIcon");return c(),r("div",null,[d,n("ul",null,[n("li",null,[n("p",null,[s("下载"),n("a",p,[s("Docker Desktop"),e(a)])])]),u]),v,n("p",null,[n("a",m,[s("安装 docker compose"),e(a)])]),k,n("p",null,[n("a",b,[s("添加用户到sudo 用户组"),e(a)])]),h,n("p",null,[n("a",g,[s("免密码登录"),e(a)])])])}const q=l(o,[["render",f],["__file","574O8PkV7.html.vue"]]);export{q as default};
