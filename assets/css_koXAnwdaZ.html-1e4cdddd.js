import{_ as n,V as s,W as a,a0 as e}from"./framework-0db4e8b6.js";const t={},p=e(`<h1 id="水平居中" tabindex="-1"><a class="header-anchor" href="#水平居中" aria-hidden="true">#</a> 水平居中</h1><h2 id="水平居中可分为行内元素水平居中和块级元素水平居中" tabindex="-1"><a class="header-anchor" href="#水平居中可分为行内元素水平居中和块级元素水平居中" aria-hidden="true">#</a> 水平居中可分为行内元素水平居中和块级元素水平居中</h2><ol><li>行内元素水平居中 这里行内元素是指文本 text、图像 img、按钮超链接等，只需给父元素设置 text-align:center 即可实现。</li></ol><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">.center</span><span class="token punctuation">{</span>
