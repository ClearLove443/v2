import{_ as s,V as a,W as e,a0 as t}from"./framework-e0f7ab62.js";const o={};function p(i,n){return a(),e("div",null,[...n[0]||(n[0]=[t(`<h1 id="docker-desktop-设置" tabindex="-1"><a class="header-anchor" href="#docker-desktop-设置" aria-hidden="true">#</a> docker desktop 设置</h1><p>Settings =&gt; Docker Engine</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6)])])}const l=s(o,[["render",p],["__file","jlMpUapWA.html.vue"]]);export{l as default};
