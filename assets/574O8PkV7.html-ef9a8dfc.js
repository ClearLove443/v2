import{_ as t,D as r,V as o,W as c,Y as s,Z as a,$ as i,a0 as l}from"./framework-7c77a285.js";const d={},p={href:"https://hub.docker.com/editions/community/docker-ce-desktop-windows",target:"_blank",rel:"noopener noreferrer"},u={href:"https://clearlove443.github.io/v2/blogs/docker/docker-compose-install.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://clearlove443.github.io/v2/blogs/linux/linux_user_add_delete.html",target:"_blank",rel:"noopener noreferrer"},k={href:"https://clearlove443.github.io/v2/blogs/linux/linux_ssh_add_privtekey.html",target:"_blank",rel:"noopener noreferrer"};function m(b,n){const e=r("ExternalLinkIcon");return o(),c("div",null,[n[6]||(n[6]=s("h2",{id:"windoww",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#windoww","aria-hidden":"true"},"#"),a(" windoww")],-1)),s("ul",null,[s("li",null,[s("p",null,[n[1]||(n[1]=a("下载")),s("a",p,[n[0]||(n[0]=a("Docker Desktop")),i(e)])])]),n[2]||(n[2]=l(`<li><p>开启 Hyper-V powershell 运行</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Enable-WindowsOptionalFeature <span class="token parameter variable">-Online</span> <span class="token parameter variable">-FeatureName</span> Microsoft-Hyper-V <span class="token parameter variable">-All</span>
