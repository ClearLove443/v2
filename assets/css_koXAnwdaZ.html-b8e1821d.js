import{_ as s,V as a,W as e,a0 as t}from"./framework-7c77a285.js";const p={};function i(l,n){return a(),e("div",null,n[0]||(n[0]=[t(`<h1 id="水平居中" tabindex="-1"><a class="header-anchor" href="#水平居中" aria-hidden="true">#</a> 水平居中</h1><h2 id="水平居中可分为行内元素水平居中和块级元素水平居中" tabindex="-1"><a class="header-anchor" href="#水平居中可分为行内元素水平居中和块级元素水平居中" aria-hidden="true">#</a> 水平居中可分为行内元素水平居中和块级元素水平居中</h2><ol><li>行内元素水平居中 这里行内元素是指文本 text、图像 img、按钮超链接等，只需给父元素设置 text-align:center 即可实现。</li></ol><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">.center</span><span class="token punctuation">{</span>
...
<span class="token property">text-align</span><span class="token punctuation">:</span>center<span class="token punctuation">;</span>
<span class="token property">vertical-align</span><span class="token punctuation">:</span> middle<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,36)]))}const o=s(p,[["render",i],["__file","css_koXAnwdaZ.html.vue"]]);export{o as default};
