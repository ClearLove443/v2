import{_ as a,V as s,W as e,a0 as i}from"./framework-7c77a285.js";const c={};function t(l,n){return s(),e("div",null,n[0]||(n[0]=[i(`<h2 id="bin-bash-c-字符串方式" tabindex="-1"><a class="header-anchor" href="#bin-bash-c-字符串方式" aria-hidden="true">#</a> /bin/bash -c 字符串方式</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">services</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token punctuation">|</span><span class="token scalar string">
    ...
    cmd2 &amp;
    cmd3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12)]))}const d=a(c,[["render",t],["__file","docker_compose_command.html.vue"]]);export{d as default};
