...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="远程访问" tabindex="-1"><a class="header-anchor" href="#远程访问" aria-hidden="true">#</a> 远程访问</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/lib/systemd/system/docker.service
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="idea-连接" tabindex="-1"><a class="header-anchor" href="#idea-连接" aria-hidden="true">#</a> idea 连接</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>TPC socket: tcp://192.168.2.201:2375
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="添加用户到sudo-用户组" tabindex="-1"><a class="header-anchor" href="#添加用户到sudo-用户组" aria-hidden="true">#</a> 添加用户到sudo 用户组</h2>`,5),b={href:"https://clearlove443.github.io/v2/blogs/linux/linux_user_add_delete.html",target:"_blank",rel:"noopener noreferrer"},h=n("h2",{id:"ssh免密码登录",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#ssh免密码登录","aria-hidden":"true"},"#"),s(" ssh免密码登录")],-1),g={href:"https://clearlove443.github.io/v2/blogs/linux/linux_ssh_add_privtekey.html",target:"_blank",rel:"noopener noreferrer"};function f(x,_){const a=t("ExternalLinkIcon");return c(),r("div",null,[o,n("ul",null,[n("li",null,[n("p",null,[s("下载"),n("a",u,[s("Docker Desktop"),e(a)])])]),p]),v,n("p",null,[n("a",k,[s("安装 docker compose"),e(a)])]),m,n("p",null,[n("a",b,[s("添加用户到sudo 用户组"),e(a)])]),h,n("p",null,[n("a",g,[s("免密码登录"),e(a)])])])}const q=l(d,[["render",f],["__file","574O8PkV7.html.vue"]]);export{q as default};
