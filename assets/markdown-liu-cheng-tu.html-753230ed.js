import{_ as e,V as i,W as n,a0 as d}from"./framework-74e9649d.js";const s={},a=d(`<h2 id="_1、横向流程图源码格式" tabindex="-1"><a class="header-anchor" href="#_1、横向流程图源码格式" aria-hidden="true">#</a> 1、横向流程图源码格式：</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>\`\`\`mermaid
graph LR
A[方形] --&gt;B(圆角)
    B --&gt; C{条件a}
    C --&gt;|a=1| D[结果1]
