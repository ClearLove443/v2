import{_ as l,D as d,V as r,W as c,Y as a,Z as n,$ as i,a0 as t}from"./framework-e0f7ab62.js";const u={},o={href:"https://juejin.cn/post/6844903955416219661",target:"_blank",rel:"noopener noreferrer"},v={href:"https://documentation.suse.com/zh-cn/sles/15-SP2/html/SLES-all/cha-security-kerberos.html",target:"_blank",rel:"noopener noreferrer"};function p(b,e){const s=d("ExternalLinkIcon");return r(),c("div",null,[e[2]||(e[2]=a("h2",{id:"kerberos-简介",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#kerberos-简介","aria-hidden":"true"},"#"),n(" kerberos 简介")],-1)),e[3]||(e[3]=a("p",null,"众所周知,kerberos 是大数据环境下最常用的安全通信的保障机制,是一种网络协议 本文不涉及 kerberos 原理,只涉及 docker 搭建 kerberos 环境",-1)),e[4]||(e[4]=a("h2",{id:"kerberos-原理",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#kerberos-原理","aria-hidden":"true"},"#"),n(" kerberos 原理")],-1)),e[5]||(e[5]=a("ul",null,[a("li",null,"Kerberos 原理")],-1)),a("p",null,[a("a",o,[e[0]||(e[0]=n("Kerberos 原理",-1)),i(s)])]),e[6]||(e[6]=a("ul",null,[a("li",null,"使用 Kerberos 进行网络身份验证")],-1)),a("p",null,[a("a",v,[e[1]||(e[1]=n("使用 Kerberos 进行网络身份验证",-1)),i(s)])]),e[7]||(e[7]=t(`<h2 id="kerberos-kdc-几个重要的概念" tabindex="-1"><a class="header-anchor" href="#kerberos-kdc-几个重要的概念" aria-hidden="true">#</a> Kerberos（KDC） 几个重要的概念：</h2><ul><li>Principal：任何服务器所提供的用户、计算机、服务都将被定义成 Principal。</li><li>Instances：用于服务 principals 和特殊管理 Principal。</li><li>Realms：Kerberos 安装提供的独特的域的控制，把它想象成你的主机和用户所属的主机或者组。官方约定这域需要大写。默认的，Ubuntu 将把 DNS 域名转换为大写当成这里的域。 本例使用</li><li>Key Distribution Center: （KDC）由三部分组成，一是 principal 数据库，认证服务器，和票据授予服务器。每个 Realm 至少要有一个。</li><li>Ticket Granting Ticket：由认证服务器（AS）签发，Ticket Granting Ticket (TGT)使用用户的密码加密，这个密码只有用户和 KDC 知道。</li><li>Ticket Granting Server: (TGS) 根据请求签发服务的票据。</li><li>Tickets：确认两个 Principal 的身份。一个主体是用户，另一个是由用户请求的服务。门票会建立一个加<code>***</code>，用于在身份验证会话中的安全通信。</li><li>Keytab Files：从 KDC 主数据库中提取的文件，并且包含的服务或主机的加***。</li></ul><h2 id="创建配置文件" tabindex="-1"><a class="header-anchor" href="#创建配置文件" aria-hidden="true">#</a> 创建配置文件</h2><h3 id="创建文件夹-home-ubuntu-docker-kerberos" tabindex="-1"><a class="header-anchor" href="#创建文件夹-home-ubuntu-docker-kerberos" aria-hidden="true">#</a> 创建文件夹/home/ubuntu/docker/kerberos</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir /home/ubuntu/docker/kerberos
...
# kdc host
192.168.50.28 kdc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用用户名和密码的方式验证-kerberos-配置在客户端通过用户名和密码认证-1" tabindex="-1"><a class="header-anchor" href="#使用用户名和密码的方式验证-kerberos-配置在客户端通过用户名和密码认证-1" aria-hidden="true">#</a> 使用用户名和密码的方式验证 kerberos 配置在客户端通过用户名和密码认证</h3><ul><li><p>admin user cloudera-scm/admin@HADOOP.COM password</p></li><li><p>hdfs usrr</p></li></ul><p>hdfs/kdc@HADOOP.COM password</p>`,74))])}const k=l(u,[["render",p],["__file","docker_create_kerberos_kdc.html.vue"]]);export{k as default};
